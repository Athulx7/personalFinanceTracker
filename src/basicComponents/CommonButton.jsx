...
function CommonButton({
  ...
  const variantClasses = {
    ...
    'delete': `bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 border border-red-600 ${
      disabled ? 'bg-red-400 border-red-400 cursor-not-allowed' : ''
    }`,
    
    'delete-bordered': `bg-white text-red-600 hover:bg-red-50 border-2 border-red-600 focus:ring-red-500 ${
      disabled ? 'text-red-300 border-red-300 cursor-not-allowed' : ''
    }`
  }
